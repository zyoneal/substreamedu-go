            ...
            <div className={`${styles.guideCard} ${step === 2 ? styles.step2 : ''} ${step === 'completed' ? styles.completed : ''}`}>
                <div className={styles.cardHeader}>
                    <div className={styles.headerLeft}>
                        {step === 1 && (
                            <>
                                <span className={styles.stepPill}>1 / 2</span>
                                <span className={styles.stepTitle}>
                                    <Sparkles size={13} className={styles.stepIcon} />
                                    {intl.formatMessage({
                        ...
                        {step === 2 && (
                            <>
                                <span className={styles.stepPill}>2 / 2</span>
                                <span className={styles.stepTitle}>
                                    <Bookmark size={13} className={styles.stepIcon} />
                                    {intl.formatMessage({
                        ...
                        {step === 'completed' && (
                            <>
                                <span className={`${styles.stepPill} ${styles.stepPillSuccess}`}>
                                    <Check size={11} strokeWidth={3} />
                                </span>
                                <span className={`${styles.stepTitle} ${styles.completedTitle}`}>
                                    <Sparkles size={13} className={styles.stepIcon} />
                                    {intl.formatMessage({
