...
import { VideoTranslationPopover } from './VideoTranslationPopover';
import { INITIAL_TRANSLATION_DATA, TranslationData } from '../types';
...
describe('VideoTranslationPopover Component', () => {
    ...
    it('renders selected text, transcription, and translation properly', () => {
        renderPopover();
    ...
    it('renders admin reel modal button and triggers onOpenReelModal', () => {
